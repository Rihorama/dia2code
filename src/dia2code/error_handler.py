...
class ErrorHandler:
    ...
    def __init__(self):
        ...
        self.err_dict["dia:direction_collision"] = ("Association between classes \"{}\" and \"{}\" contains colliding direction data. "
                                                    "Displayed arrows do not correspond with the set direction. Synchronization of the "
                                                    "two is mandatory due to an existing direction bug in Dia UML XML. For this program "
                                                    "to generate a correct code, we reccomend setting Direction to None and leaving only "
                                                    "the arrows. For undirected association (= both sides know about the other) set "
                                                    "Direction to None and both arrow visibility to No.")
        ...
        self.err_dict["parser:class_wrong_dia"] = ("In class diagram parser: Your dia xml file does not contain "
                                                   "elements required for dia2code to work in the class mode "
                                                   "(\"UML - Class\"). Did you perhaps mean to work in the database "
                                                   "mode? Type -h, --help for help.")
        ...
        self.err_dict["parser:database_wrong_dia"] = ("In ER diagram parser: Your dia xml file does not contain "
                                                      "elements required for dia2code to work in the database mode "
                                                      "(\"Database - Table\"). Did you perhaps mean to work in the class "
                                                      "mode? Type -h, --help for help.")
        ...
        self.err_dict["generator:wrong_multiplicity"] = ("In cls_association.py: Encountered invalid association "
                                                         "multiplicity (\"{}\") for class \"{}\". Allowed format: "
                                                         "\"x\", \"x..y\" or \"*\" where x is decimal, y is decimal or *.")
